...
private user:User;
  ...
  constructor(private _http:Http) {}
    ...
    getUser(id:Number)
    {
      ...
      return this._http.get(this.baseUrl+'/User1/'+id,this.options).map((response:Response)=>response.json())
      .catch(this.errorHandler);
    }
    ...
    deleteUser(id:Number)
    {
      ...
      return this._http.delete(this.baseUrl+'/User1/'+id,this.options).map((response:Response)=>response.json())
      .catch(this.errorHandler);
    }
